...
def get_symbol_generator():
    ...
    up_conv7 = mx.sym.Deconvolution(data=up_relu7, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf * 8,
    ...
    up_conv6 = mx.sym.Deconvolution(data=up_relu6, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf * 8,
    ...
    up_conv5 = mx.sym.Deconvolution(data=up_relu5, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf * 8,
    ...
    up_conv4 = mx.sym.Deconvolution(data=up_relu4, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf * 4,
    ...
    up_conv3 = mx.sym.Deconvolution(data=up_relu3, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf * 2,
    ...
    up_conv2 = mx.sym.Deconvolution(data=up_relu2, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=ngf,
                                    no_bias=True, name='up_conv3')
    ...
    up_conv1 = mx.sym.Deconvolution(data=up_relu1, kernel=(4, 4), stride=2, pad=(1, 1), num_filter=3,
                                    name='up_conv1')
